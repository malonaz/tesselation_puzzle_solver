...
$(MOCK_SOLVER_TARGET) $(IMAGE_PROCESSOR_TARGET) $(SOLVER_PROGRAM_TARGET) $(PIECES_GENERATOR_TARGET) $(PUZZLE_BREAKER_TARGET)
...
include $(MAKEDIR)/puzzle_breaker.mk
...
.PHONY: clean check $(COVDIR) $(TEST_TARGET) $(DEMO_TARGET) $(IMAGE_PROCESSOR_TARGET) $(MOCK_PROCESSOR_TARGET) $(MOCK_SOLVER_TARGET) $(PIECES_GENERATOR_TARGET) $(PUZZLE_BREAKER_TARGET)
